...
class StrokeExperiment(Experiment):
    def __init__(self):
        self.params = {
            'project_name': 'stroke',
            'experiment_name': 'ResNet-50-WBCE-lr1e-4-bsize-16-pretrained-0-dataaug-2-TL-0',
            # 'project_name': 'debug',
            ...
            'neptune': {
                ...
                'workspace': 'machining',
                'project': 'stroke',
                'tags': ['Stroke', 'ResNet-50-WBCE-lr1e-4-bsize-16-pretrained-0-dataaug-2-TL-0'],
        ...
        self.model = ResNet(net_type='ResNet-50', pre_trained=False, req_grad=True, out_channels=2,
                            input_dim=(3, 512, 512))
