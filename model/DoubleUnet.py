...
class DoubleUnet(BaseModel):
    def __init__(self, out_features=3, k=1, k1=1, norm_type='bn', upsample_mode='bilinear', device='cuda'):
        ...
        self.ASPP_1 = DoubleASPP(in_features=512, out_features=int(64 * k1), norm_type=norm_type)

        self.decode1_0 = self.upsample
        self.decode1_1 = nn.Sequential(
            conv_block(in_features=int(64 * k1) + 512, out_features=int(256 * k), norm_type=norm_type),
        ...
        self.decode1_2 = nn.Sequential(
            conv_block(in_features=int(256 * k) + 256, out_features=int(128 * k), norm_type=norm_type),
        ...
        self.decode1_3 = nn.Sequential(
            conv_block(in_features=int(128 * k) + 128, out_features=int(64 * k), norm_type=norm_type),
        ...
        self.decode1_4 = nn.Sequential(
            conv_block(in_features=int(64 * k) + 64, out_features=int(32 * k), norm_type=norm_type),
        ...
        self.output1 = nn.Sequential(
            nn.Conv2d(int(32 * k), 3, kernel_size=(1, 1)),
            nn.Sigmoid())

        self.encode2_1 = nn.Sequential(
            conv_block(in_features=3, out_features=int(32 * k), norm_type=norm_type),
            conv_block(in_features=int(32 * k), out_features=int(32 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(32 * k), reduction=8))
        self.encode2_2 = nn.Sequential(
            self.maxpool,
            conv_block(in_features=int(32 * k), out_features=int(64 * k), norm_type=norm_type),
            conv_block(in_features=int(64 * k), out_features=int(64 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(64 * k), reduction=8))
        self.encode2_3 = nn.Sequential(
            self.maxpool,
            conv_block(in_features=int(64 * k), out_features=int(128 * k), norm_type=norm_type),
            conv_block(in_features=int(128 * k), out_features=int(128 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(128 * k), reduction=8))
        self.encode2_4 = nn.Sequential(
            self.maxpool,
            conv_block(in_features=int(128 * k), out_features=int(256 * k), norm_type=norm_type),
            conv_block(in_features=int(256 * k), out_features=int(256 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(256 * k), reduction=8))
        self.encode2_5 = self.maxpool

        self.ASPP_2 = DoubleASPP(in_features=int(256 * k), out_features=int(64 * k1), norm_type=norm_type)

        self.decode2_0 = self.upsample
        self.decode2_1 = nn.Sequential(
            conv_block(in_features=int(64 * k1) + 512 + int(256 * k), out_features=int(256 * k), norm_type=norm_type),
            conv_block(in_features=int(256 * k), out_features=int(256 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(256 * k), reduction=8),
            self.upsample)
        self.decode2_2 = nn.Sequential(
            conv_block(in_features=int(256 * k) + 256 + int(128 * k), out_features=int(128 * k), norm_type=norm_type),
            conv_block(in_features=int(128 * k), out_features=int(128 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(128 * k), reduction=8),
            self.upsample)
        self.decode2_3 = nn.Sequential(
            conv_block(in_features=int(128 * k) + 128 + int(64 * k), out_features=int(64 * k), norm_type=norm_type),
            conv_block(in_features=int(64 * k), out_features=int(64 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(64 * k), reduction=8),
            self.upsample)
        self.decode2_4 = nn.Sequential(
            conv_block(in_features=int(64 * k) + 64 + int(32 * k), out_features=int(32 * k), norm_type=norm_type),
            conv_block(in_features=int(32 * k), out_features=int(32 * k), norm_type=norm_type),
            SqueezeExciteBlock(in_features=int(32 * k), reduction=8))

        self.output2 = nn.Conv2d(int(32 * k), out_features, kernel_size=(1, 1), padding=(0, 0))
